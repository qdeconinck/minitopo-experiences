    ...
    def testsScheduler(**kwargs):
        def testsOpenBup(**kwargs):
            def testsFastJoin(**kwargs):
                def testsCc(**kwargs):
                    def test(**kwargs):
                        ...
                        xpDict = {
                            ...
                            SIRI_BUFFER_SIZE: 9,
                            SIRI_BURST_SIZE: 9,
                            SIRI_INTERVAL_BURST_TIME_MS: 5000,
                            MSG_SERVER_SLEEP: 0.0,
                            MSG_CLIENT_SLEEP: 0.1,
                            MSG_NB_REQUESTS: 300,
                ...
                core.experimentFor("fastJoin", [0] if kwargs["openBup"] == 0 else [0], testsCc, **kwargs)

            core.experimentFor("openBup", ["1"], testsFastJoin, **kwargs)

        core.experimentFor("scheduler", schedulers, testsOpenBup, **kwargs)

    core.experimentTopos(topos, "sirimsg", protocol, tmpfs, testsScheduler)
